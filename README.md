...
A simple solver for mini game in **Sumikko Farm**
...
- To delete the filled position, tap the `Del` first, then tap the corresponding position above
...
[Privacy](https://boris4110799.github.io/SumiShisen/)